...
$sql = "SELECT * FROM top_ordered LIMIT 3";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p><img style='height: fill-content; width: 100px; margin-left: 10px;' src='" . $row["image"] . "' width='100' height='100'></p>";
        echo "</div>";
        echo "<div style='min-width: 240px;  margin-left: 10px;'>";
        ...
        echo "<p style='font-size: 12px; width: 63%; margin-top: -15px; font-weight: bold; color: #888;'>" . $limitedDescription . "</p>";
